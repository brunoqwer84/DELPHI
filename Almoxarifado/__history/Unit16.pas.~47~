...
procedure Tfiltros_consumo.Button1Click(Sender: TObject);
  ...
  begin
    ...
    dat := (FormatDateTime('yyyy-mm-dd hh-mm-ss',sel_data2.Date));
    dat2 := (FormatDateTime('yyyy-mm-dd 23-59-59',sel_data3.Date));
    ...
    dm.rel_consumo.Variables['setor']:= QuotedStr(box_setor.Text);
